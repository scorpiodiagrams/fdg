...
### Walking on a Sphere
  ...
  For example, let $\mu$ map the time line to the unit sphere.#FootnoteRef(2) We use
...
\end{equation}$$
   ...
   currying#FootnoteRef(4) of the integral curve of $\mathsf{v}$ from $\mathsf{m}$ as a a
